...
describe('Exercise02Strategy', () => {
    ...
    it('#resolve2 Quand on reçoit une liste de parties composées de différents tirages, alors retourne la somme des puissances minimales de toutes les parties', () => {
        // Given
        const data: string[] = [
        ...
        // When && Then
        expect(strategy.resolve2(data)).toEqual(2286);
    });
});
